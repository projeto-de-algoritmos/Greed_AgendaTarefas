...
class TelaAgenda:
    ...
    def __init__(self):
        ...
        layout = [
            ...
            [sg.Text('Marque o prazo do seu trabalho'),
             sg.Text('Tempo estimado para conclusão')],
            [sg.Input(key='-Calendar-', size=(20, 1)), sg.CalendarButton('Calendário', close_when_date_chosen=True,  target='-Calendar-',
                                                                         location=(0, 0), no_titlebar=False, format='%d-%m-%Y',), sg.Input(key='-Estimativa-', size=(20, 1), pad=5)],
